$(document).ready(function(){
    ...
    // Date picker
    $.each($('.sfWidgetFormDatePicker'), function(){
        ...
        // Read initial date
        if ($selects.filter('select[name$="[day]"]').val() != '') { // One is just enough to see there is a date set
    ...
    // Time picker
    $.each($('.sfWidgetFormTimePicker'), function(){
        // This is Admin UI support
        var initialValue = '';
